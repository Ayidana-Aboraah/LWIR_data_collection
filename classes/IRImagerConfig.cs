...
public class IRImagerConfig : global::System.IDisposable {
  ...
  /// <summary>Use Size of Source Correction if available in calibration data.</summary>
  /// If true, Size of Source Correction will automatically be used if available in calibration data.
  public bool enableSoSCorrection {
    set {
      otcsdkPINVOKE.IRImagerConfig_enableSoSCorrection_set(swigCPtr, value);
    } 
    get {
  ...
  /// <summary>Radiation parameters for the overall thermal frame.</summary>
  ...
  public RadiationParameters radiation {
    set {
      otcsdkPINVOKE.IRImagerConfig_radiation_set(swigCPtr, RadiationParameters.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = otcsdkPINVOKE.IRImagerConfig_radiation_get(swigCPtr);
  ...
  /// <summary>Indicates whether a flag timeout that caused the failure of a flag cycle should trigger the fail safe.</summary>
  ...
  public bool failSafeFlagTimeouts {
    set {
      otcsdkPINVOKE.IRImagerConfig_failSafeFlagTimeouts_set(swigCPtr, value);
    } 
    get {
      bool ret = otcsdkPINVOKE.IRImagerConfig_failSafeFlagTimeouts_get(swigCPtr);
      return ret;
    } 
  }

  /// <summary>Specifies the number of failed flag cycles to be tolerated before fail safe is triggered due to flag timeouts.</summary>
  /// <seealso cref="IRImagerConfig.failSafeTriggerOnFlagTimeout"/>
  public int failSafeFlagTimeoutsMaxCycleFailures {
    set {
      otcsdkPINVOKE.IRImagerConfig_failSafeFlagTimeoutsMaxCycleFailures_set(swigCPtr, value);
    } 
    get {
      int ret = otcsdkPINVOKE.IRImagerConfig_failSafeFlagTimeoutsMaxCycleFailures_get(swigCPtr);
      return ret;
    } 
  }

  /// <summary>Indicates whether a failure of the processing chain to reach all of its endpoints (thermal frame and measurement fields) within a given       time frame should trigger the fail safe.</summary>
  /// If set to false, the fail safe will still be triggered when the processing chain itself crashes or gets stuck.
  public bool failSafeProcessingChainTimeouts {
    set {
      otcsdkPINVOKE.IRImagerConfig_failSafeProcessingChainTimeouts_set(swigCPtr, value);
    } 
    get {
      bool ret = otcsdkPINVOKE.IRImagerConfig_failSafeProcessingChainTimeouts_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public MeasurementFieldConfigVector measurementFields {
    set {
      otcsdkPINVOKE.IRImagerConfig_measurementFields_set(swigCPtr, MeasurementFieldConfigVector.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = otcsdkPINVOKE.IRImagerConfig_measurementFields_get(swigCPtr);
      MeasurementFieldConfigVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new MeasurementFieldConfigVector(cPtr, false);
      return ret;
    } 
  }

  ///  Processing interface configuration.
  public PifConfig processInterface {
    set {
      otcsdkPINVOKE.IRImagerConfig_processInterface_set(swigCPtr, PifConfig.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = otcsdkPINVOKE.IRImagerConfig_processInterface_get(swigCPtr);
      PifConfig ret = (cPtr == global::System.IntPtr.Zero) ? null : new PifConfig(cPtr, false);
      return ret;
    } 
  }
